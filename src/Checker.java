...
public class Checker {
	...
	public static final String EXEC_FILE_NAME = "Assignment2";
	...
	public static final String JAVA_HOME = "C:\\Program Files\\Java\\jdk1.8.0_20\\bin\\";
	...
	public static final String CORRECT_LOCATION = "D:\\Test\\Correct";
	public static final String REPORT_LOCATION = "D:\\Test\\Reports";
	public static final String STUDENT_LOCATION = "D:\\Test\\Students";
	public static final String INPUT_LOCATION = "D:\\Test\\Tests";
	...
	public static final int COUNT_COMMENTS = 4; // Quick hack, may count more comments than there is in the file. But not the other way around. Non positive number disables the check.
	...
	public static final boolean DEBUG_PRINT_TEACHER_EXE_DELETED = true;

	//Set timeout used to catch infinite loops.
	public static final int PROGRAM_TIMEOUT_IN_SECONDS = 10;
	...
	private static void hardcodedTestScores(Map<String, Integer> scoresPerTest){
		...
		if (true){
			scoresPerTest.put("1.txt", 4);
			scoresPerTest.put("2.txt", 4);
			scoresPerTest.put("3.txt", 4);
			scoresPerTest.put("4.txt", 5);
			scoresPerTest.put("5.txt", 5);
			scoresPerTest.put("6.txt", 5);
			scoresPerTest.put("7.txt", 5);
			scoresPerTest.put("8.txt", 5);
			scoresPerTest.put("9.txt", 5);
			scoresPerTest.put("10.txt", 3);
			scoresPerTest.put("11.txt", 3);
			scoresPerTest.put("12.txt", 3);
			scoresPerTest.put("13.txt", 6);
			scoresPerTest.put("14.txt", 6);
			scoresPerTest.put("15.txt", 6);
			scoresPerTest.put("16.txt", 5);
			scoresPerTest.put("17.txt", 5);
			scoresPerTest.put("18.txt", 3);
			scoresPerTest.put("19.txt", 3);
			scoresPerTest.put("20.txt", 3);
			scoresPerTest.put("21.txt", 3);
			scoresPerTest.put("22.txt", 2);
			scoresPerTest.put("23.txt", 2);
			scoresPerTest.put("24.txt", 5);
		}else{
			scoresPerTest.put("1.txt", 10);
			scoresPerTest.put("2.txt", 15);
			scoresPerTest.put("3.txt", 15);
			scoresPerTest.put("4.txt", 10);
			scoresPerTest.put("5.txt", 15);
			scoresPerTest.put("6.txt", 10);
			scoresPerTest.put("7.txt", 7);
			scoresPerTest.put("8.txt", 8);
			scoresPerTest.put("9.txt", 10);
		}
...
///////////////////////////There is no need to change anything past this point, unless you're modifying the code//////////////////////////
	...
	private static boolean wordCounter(String path) throws IOException {
		...
		return badFunc || badArray || badLoops || badComments;
	...
	private static boolean checkScores(Map<String,Integer> score) {
		...
		if (sum != 100) {
			System.err.println("score doesn't add up to 100");
			return false;
	...
	private static CheckResult checkProject(File projectRoot, File[] tests, Map<String,Integer> scorePerTest, List<String> correctAnswers) {
		if (tests != null && tests.length > 0) {
			...
			return new CheckResult(status, totalScore, note);
		} else {
			...
			if (isCorrect) {
				return new CheckResult(CheckResult.Status.OK, 100, "");
			} else {
	...
	public static void check() {
		...
		for (File projectDir : projectDirs) {
			...
			sumOfGrades += res.score;

			String fullReportLine = groupID + ',' + groupName + ',' + res.score + ',' + zeroForTechnicalReasons + ',' + finalScore + ',' + res.note + '\n';
		...
		saveReport(submissionSystemReport.toString(), REPORT_LOCATION, "reportSubmissionSystem.txt");
